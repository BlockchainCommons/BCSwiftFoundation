...
struct ReadMeTests {
    @Test func testDeriveAddressFromSeed() {
        ...
        #expect(masterKey.keyFingerprint.hex == "7b343b65")
        let path = DerivationPath(string: "m/44'/0'/0'")!
        let accountKey = try! HDKey(parent: masterKey, childDerivationPath: path)
        #expect(accountKey.base58PrivateKey == "xprv9z3bixmawU269r5jUAbWbVFDY3qN6LZdHH7r28C7gmZMXPfbN8o39622JvuyvQxBYPBMEtJNetWBCyy6hZXcAEubReyb95MnJQR5bAMiR2d")
        #expect(accountKey.base58PublicKey == "xpub6D2x8UJUmqaPNLACaC8WxdBx65frVoHUeW3SpWbjF76LQBzjug7HgtLWACEbNoRubqXqM9y7t822g9RpEPPxmALG8tiZYVw5Ec66swihmUy")
        #expect(Bitcoin.Address(hdKey: accountKey, type: .payToWitnessPubKeyHash).description == "bc1qtqq3hzwgswm56tt3h04ss8qmmttt6py9yj8h6c")
    }
    
    @Test func testDeriveAddressFromXpub() {
        ...
        #expect(address.description == "1BiCdXSDHyeXSzmx2paVPFVTrmyx7BeCGD")
        #expect(address.scriptPubKey.description == "pkh:[OP_DUP OP_HASH160 757c05317fcb85e910c5f3e6cd9dc4d06b5d8321 OP_EQUALVERIFY OP_CHECKSIG]")
    }
    
    @Test func testParseAddress() {
        let address = Bitcoin.Address(string: "bc1q6zwjfmhdl4pvhvfpv8pchvtanlar8hrhqdyv0t")!
        #expect(address.scriptPubKey.hex == "0014d09d24eeedfd42cbb12161c38bb17d9ffa33dc77")
        #expect(address.scriptPubKey.type! == .wpkh)
        #expect(address.scriptPubKey.description == "wpkh:[OP_0 d09d24eeedfd42cbb12161c38bb17d9ffa33dc77]")
    }
    
    @Test func testCreateAndSignTransaction() {
        ...
        #expect(signedTx.description == "")
