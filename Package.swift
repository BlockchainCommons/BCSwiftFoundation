...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/BlockchainCommons/BCSwiftSecureComponents.git", from: "4.1.1"),
        .package(url: "https://github.com/BlockchainCommons/BCSwiftEnvelope.git", from: "0.10.0")
    ],
    targets: [
        .target(
            name: "BCFoundation",
