...
class IdentityTests: XCTestCase {
    func testIdentity() {
        ...
        XCTAssertEqual(identity.signingPublicKey.data, ‡"72dd19bc0ebf5ba3dc2abc68b121e89f35169fb481ef3efed6beea30fc4b7759")
        XCTAssertEqual(identity.agreementPrivateKey.data, ‡"5566b162781c0294a051209131e0c606c37f2c359515aa0160ad3a3255b9deb4")
        XCTAssertEqual(identity.agreementPublicKey.data, ‡"040b0105518b038012319b5956059a7601bd8ada36b4e98386e801789627a40d")
    }
}
