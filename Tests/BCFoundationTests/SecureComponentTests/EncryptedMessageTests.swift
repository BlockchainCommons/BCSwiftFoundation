...
fileprivate let key = SymmetricKey(rawValue: ‡"808182838485868788898a8b8c8d8e8f909192939495969798999a9b9c9d9e9f")!
...
class EncryptedMessageTests: XCTestCase {
    ...
    func testCBOR() {
        ...
        XCTAssertEqual(secureMessage.taggedCBOR.encoded, expectedCBOR)
    }
