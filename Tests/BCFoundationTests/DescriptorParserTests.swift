...
class DescriptorParserTests: XCTestCase {
    func testRaw() throws {
        ...
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90198581976a914bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe88ac")
    ...
    func testPK() throws {
        ...
        XCTAssertEqual(desc1.taggedCBOR.cborData, ‡"d90134d90192d90132a103582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f2")
        ...
        XCTAssertEqual(desc2.taggedCBOR.cborData, ‡"d90134d90192d90132a103584104e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f22fa358bbfca32197efabe42755e5ab36c73b9bfee5b6ada22807cb125c1b7a27")
        ...
        XCTAssertEqual(desc3.taggedCBOR.cborData, ‡"d90134d90192d90132a202f5035820347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e")
        ...
        XCTAssertEqual(desc4.taggedCBOR.cborData, ‡"d90134d90192d9012fa602f503582100347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e0458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
        ...
        XCTAssertEqual(desc5.taggedCBOR.cborData, ‡"d90134d90192d9012fa503582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f20458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
    }
    ...
    func testCosigner() throws {
        ...
        XCTAssertEqual(desc1.unparsed, desc1.source)
        XCTAssertEqual(desc1.taggedCBOR.cborData, ‡"d90134d9019ad90132a103582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f2")
        
        let desc2 = try OutputDescriptor("cosigner(\(ecPubUncompressed))")
        XCTAssertNil(desc2.scriptPubKey())
        XCTAssertEqual(desc2.unparsed, desc2.source)
        XCTAssertEqual(desc2.taggedCBOR.cborData, ‡"d90134d9019ad90132a103584104e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f22fa358bbfca32197efabe42755e5ab36c73b9bfee5b6ada22807cb125c1b7a27")

        let desc3 = try OutputDescriptor("cosigner(\(wif))")
        XCTAssertNil(desc3.scriptPubKey())
        XCTAssertEqual(desc3.unparsed, desc3.source)
        XCTAssertEqual(desc3.taggedCBOR.cborData, ‡"d90134d9019ad90132a202f5035820347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e")

        let desc4 = try OutputDescriptor("cosigner(\(tprv))")
        XCTAssertNil(desc4.scriptPubKey())
        XCTAssertEqual(desc4.unparsed, desc4.source)
        XCTAssertEqual(desc4.taggedCBOR.cborData, ‡"d90134d9019ad9012fa602f503582100347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e0458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")

        let desc5 = try OutputDescriptor("cosigner(\(tpub))")
        XCTAssertNil(desc5.scriptPubKey())
        XCTAssertEqual(desc5.unparsed, desc5.source)
        XCTAssertEqual(desc5.taggedCBOR.cborData, ‡"d90134d9019ad9012fa503582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f20458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
    }
    ...
    func testPKH() throws {
        ...
        XCTAssertEqual(desc1.unparsed, desc1.source)
        XCTAssertEqual(desc1.taggedCBOR.cborData, ‡"d90134d90193d90132a103582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f2")
        ...
        XCTAssertEqual(desc2.unparsed, desc2.source)
        XCTAssertEqual(desc2.taggedCBOR.cborData, ‡"d90134d90193d90132a103584104e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f22fa358bbfca32197efabe42755e5ab36c73b9bfee5b6ada22807cb125c1b7a27")
        ...
        XCTAssertEqual(desc3.unparsed, desc3.source)
        XCTAssertEqual(desc3.taggedCBOR.cborData, ‡"d90134d90193d90132a202f5035820347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e")
        ...
        XCTAssertEqual(desc4.unparsed, desc4.source)
        XCTAssertEqual(desc4.taggedCBOR.cborData, ‡"d90134d90193d9012fa602f503582100347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e0458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
        ...
        XCTAssertEqual(desc5.unparsed, desc5.source)
        XCTAssertEqual(desc5.taggedCBOR.cborData, ‡"d90134d90193d9012fa503582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f20458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
    }
    ...
    func testWPKH() throws {
        ...
        XCTAssertEqual(desc1.unparsed, desc1.source)
        XCTAssertEqual(desc1.taggedCBOR.cborData, ‡"d90134d90194d90132a103582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f2")
        ...
        XCTAssertEqual(desc2.unparsed, desc2.source)
        XCTAssertEqual(desc2.taggedCBOR.cborData, ‡"d90134d90194d90132a103584104e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f22fa358bbfca32197efabe42755e5ab36c73b9bfee5b6ada22807cb125c1b7a27")
        ...
        XCTAssertEqual(desc3.unparsed, desc3.source)
        XCTAssertEqual(desc3.taggedCBOR.cborData, ‡"d90134d90194d90132a202f5035820347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e")
        ...
        XCTAssertEqual(desc4.unparsed, desc4.source)
        XCTAssertEqual(desc4.taggedCBOR.cborData, ‡"d90134d90194d9012fa602f503582100347c4acb73f7bf2268b958230e215986eda87a984959c4ddbd4d62c07de6310e0458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
        ...
        XCTAssertEqual(desc5.unparsed, desc5.source)
        XCTAssertEqual(desc5.taggedCBOR.cborData, ‡"d90134d90194d9012fa503582103e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f20458205b74b3709e229bc49589525249b8997e83a5387c27fef500f2f2e1d608757bb305d90131a1020106d90130a3018200f5021a4efd3ded0303081ae0c98d67")
    }
    ...
    func testMulti() throws {
        ...
        XCTAssertEqual(desc1.unparsed, desc1.source)
        XCTAssertEqual(desc1.taggedCBOR.cborData, ‡"d90134d90196a201010282d90132a1035821022f8bde4d1a07209355b4a7250a5c5128e88b84bddc619ab7cba8d569b240efe4d90132a1035821025cbdf0646e5db4eaa398f365f2ea7a0e3d419b7e0330e39ce92bddedcac4f9bc")
        ...
        XCTAssertEqual(desc2.unparsed, desc2.source)
        XCTAssertEqual(desc2.taggedCBOR.cborData, ‡"")
    }
    ...
    func testSortedMulti2() throws {
        ...
        XCTAssertEqual(desc.unparsed, source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"")
    }
    ...
    func testAddr() throws {
        ...
        XCTAssertEqual(desc1.taggedCBOR.cborData, ‡"d90134d90133a301d90131a10201020003544efd3ded47d967e4122982422c9d84db60503972")
        ...
        XCTAssertEqual(desc2.taggedCBOR.cborData, ‡"d90134d90133a301d90131a10201020103548fb371a0195598d96e634b9eddb645fa1f128e11")

        let desc3 = try OutputDescriptor("addr(\(p2wpkh))")
        XCTAssertEqual(desc3.unparsed, desc3.source)
        XCTAssertEqual(desc3.scriptPubKey()†, "wpkh:[OP_0 4efd3ded47d967e4122982422c9d84db60503972]")
        XCTAssertEqual(desc3.taggedCBOR.cborData, ‡"d90134d90133a301d90131a10201020203544efd3ded47d967e4122982422c9d84db60503972")
    }
    ...
    func testHDKey1() throws {
        ...
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90193d9012fa503582102d2b36900396c9282fa14628566582f206a5dd0bcc8d5e892611806cafb0301f0045820637807030d55d01f9a0cb3a7839515d796bd07706386a6eddf06cc29a65a0e2906d90130a20186182cf500f500f5021ad34db33f07d90130a1018401f480f4081a78412e3a")
    }
    ...
    func testHDKey2() throws {
        ...
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90193d9012fa603582102b705663fa1839bc7de73fcb18038a75facb7509df15230379147011ebb343140045820d10491ab8729ef3ca5e7555f54f04605d06b01b35e379b2cdc2fcae271410a9805d90131a1020106d90130a20186182cf500f500f5021a4efd3ded07d90130a1018401f580f4081a10d66527")
    ...
    func test_SH_WPKH() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90190d90194d90132a103582103fff97bd5755eeea420453a14355235d382f6472f8568a18b2f057a1460297556")
    }
    ...
    func test_WSH_PKH() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90191d90193d90132a103582102e493dbf1c10d80f3581e4904930b1404cc6c13900ee0758474fa94abe8c4cd13")
    }
    ...
    func test_SH_WSH_PKH() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90190d90191d90193d90132a103582102e493dbf1c10d80f3581e4904930b1404cc6c13900ee0758474fa94abe8c4cd13")
    }
    ...
    func test_SH_MULTI() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90190d90196a201020282d90132a1035821022f01e5e15cca351daff3843fb70f3c2f0a1bdd05e5af888a67784ef3e10a2a01d90132a103582103acd484e2f0c7f65309ad178a9f559abde09796974c57e714c35f110dfc27ccbe")
    }
    ...
    func test_SH_SORTEDMULTI() throws {
        ...
        XCTAssertEqual(desc.scriptPubKey()†, "sh:[OP_HASH160 a6a8b030a38762f4c1f5cbe387b61a3c5da5cd26 OP_EQUAL]")
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90190d90197a201020282d90132a103582103acd484e2f0c7f65309ad178a9f559abde09796974c57e714c35f110dfc27ccbed90132a1035821022f01e5e15cca351daff3843fb70f3c2f0a1bdd05e5af888a67784ef3e10a2a01")
    }
    ...
    func test_WSH_MULTI() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"")
    }
    ...
    func test_SH_WSH_MULTI() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"")
    }
    ...
    func test_WSH_MULTI_HD() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"")
    }
    ...
    func test_WSH_MULTI_HD_2() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"")
    ...
    func testCombo1() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90195d90132a1035821022f01e5e15cca351daff3843fb70f3c2f0a1bdd05e5af888a67784ef3e10a2a01")
    }
    ...
    func testCombo2() throws {
        ...
        XCTAssertEqual(desc.unparsed, desc.source)
        XCTAssertEqual(desc.taggedCBOR.cborData, ‡"d90134d90195d90132a103584104e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f22fa358bbfca32197efabe42755e5ab36c73b9bfee5b6ada22807cb125c1b7a27")
    }
