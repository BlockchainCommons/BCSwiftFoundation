...
class AddressTests: XCTestCase {
    ...
    func testDeriveLegacyAddress() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData, ‡"d90133a301d90131a002000354bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe")
    }
    ...
    func testDeriveLegacyAddressTestnet() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData, ‡"d90133a301d90131a10201020003544efd3ded47d967e4122982422c9d84db60503972")
    }
    ...
    func testDeriveWrappedSegWitAddress() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData, ‡"d90133a301d90131a00201035486cc442a97817c245ce90ed0d31d6dbcde3841f9")
    }
    ...
    func testDeriveWrappedSegWitAddressTestnet() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData, ‡"d90133a301d90131a10201020103548fb371a0195598d96e634b9eddb645fa1f128e11")
    }
    ...
    func testDeriveNativeSegWitAddress() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData, ‡"d90133a301d90131a002020354bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe")
    }
    ...
    func testDeriveNativeSegWitAddressTestnet() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData, ‡"d90133a301d90131a10201020203544efd3ded47d967e4122982422c9d84db60503972")
    }
