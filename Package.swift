...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/BlockchainCommons/BCSwiftSecureComponents.git", from: "3.1.0"),
        .package(url: "https://github.com/BlockchainCommons/BCSwiftEnvelope.git", from: "0.4.0")
    ],
    targets: [
        .target(
            name: "BCFoundation",
