...
class AddressTests: XCTestCase {
    ...
    func testDeriveLegacyAddress() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData.hex, "d99d73a301d99d71a002000354bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe")
    }
    ...
    func testDeriveLegacyAddressTestnet() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData.hex, "d99d73a301d99d71a10201020003544efd3ded47d967e4122982422c9d84db60503972")
    }
    ...
    func testDeriveWrappedSegWitAddress() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData.hex, "d99d73a301d99d71a00201035486cc442a97817c245ce90ed0d31d6dbcde3841f9")
    }
    ...
    func testDeriveWrappedSegWitAddressTestnet() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData.hex, "d99d73a301d99d71a10201020103548fb371a0195598d96e634b9eddb645fa1f128e11")
    }
    ...
    func testDeriveNativeSegWitAddress() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData.hex, "d99d73a301d99d71a002020354bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe")
    }
    ...
    func testDeriveNativeSegWitAddressTestnet() {
        ...
        XCTAssertEqual(address.taggedCBOR.cborData.hex, "d99d73a301d99d71a10201020203544efd3ded47d967e4122982422c9d84db60503972")
    }
    ...
    func testParseLegacyAddress() throws {
        ...
        XCTAssertEqual(cbor.hex, "d99d73a301d99d71a002000354bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe")
    ...
    func testParseWrappedSegWitAddress() throws {
        ...
        let cbor = address.taggedCBOR.cborData
        XCTAssertEqual(cbor.hex, "d99d73a301d99d71a00201035486cc442a97817c245ce90ed0d31d6dbcde3841f9")
        let address2 = try Bitcoin.Address(taggedCBOR: CBOR(cbor))
        XCTAssertEqual(address, address2)
    }
    ...
    func testParseNativeSegWitAddress() throws {
        ...
        let cbor = address.taggedCBOR.cborData
        XCTAssertEqual(cbor.hex, "d99d73a301d99d71a002020354bef5a2f9a56a94aab12459f72ad9cf8cf19c7bbe")
        let address2 = try Bitcoin.Address(taggedCBOR: CBOR(cbor))
        XCTAssertEqual(address, address2)
    }
    ...
    func testParseTaprootAddress() throws {
        ...
        let cbor = address.taggedCBOR.cborData
        XCTAssertEqual(cbor.hex, "d99d73a301d99d71a0020203582079be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798")
        let address2 = try Bitcoin.Address(taggedCBOR: CBOR(cbor))
        XCTAssertEqual(address, address2)
    }
