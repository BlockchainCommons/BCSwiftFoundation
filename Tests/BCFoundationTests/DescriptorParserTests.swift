...
struct DescriptorParserTests {
    ...
    func checkRoundTrip(
        ...
        #expect(desc.unparsed == desc.source)
        #expect(desc.source == source)
        
        if let scriptPubKey {
            #expect(desc.scriptPubKey()† == scriptPubKey)
        }
    ...
    @Test func testRaw() throws {
        ...
        #expect(desc.ur† == "ur:output-descriptor/oeadiojphsktdefzdydtaolyhdcfkoptbbrnykoeytonimmwpkpadkhkyldrtatklkwnnskgrnlopskovafstb")
    ...
    @Test func testCosigner1() throws {
    ...
    @Test func testCosigner2() throws {
    ...
    @Test func testCosigner3() throws {
    ...
    @Test func testCosigner4() throws {
    ...
    @Test func testCosigner5() throws {
    ...
    func sortedMultiTest(threshold: Int, keys: [String], script: String, address: String, cborHex: String, diag: String) throws {
        ...
        let desc = try OutputDescriptor(source)
        #expect(desc.scriptPubKey()?.hex == script)
    ...
    @Test func testSortedMulti1() throws {
        try sortedMultiTest(
            threshold: 2,
            keys: [
    ...
    @Test func testSortedMulti2() throws {
        try sortedMultiTest(
            threshold: 2,
            keys: [
    ...
    @Test func testSortedMulti3() throws {
        try sortedMultiTest(
            threshold: 2,
            keys: [
    ...
    @Test func testSortedMulti4() throws {
        try sortedMultiTest(
            threshold: 2,
            keys: [
    ...
    @Test func testSortedMulti5() throws {
        ...
        let desc = try OutputDescriptor(source)
        #expect(desc.scriptPubKey()?.asm == "OP_1 02fc9e5af0ac8d9b3cecfe2a888e2117ba3d089d8585886c9c826b6b22a98d12ea 03cbcaa9c98c877a26977d00825c956a238e8dddfbd322cce4f74b0b5bd6ace4a7 OP_2 OP_CHECKMULTISIG")
        #expect(checkRoundTrip(
            source: source,
    ...
    @Test func testAddr1() throws {
        let addressp2pkh = Bitcoin.Address(hdKey: Self.hdKey, type: .payToPubKeyHash).string
        #expect(addressp2pkh == "mnicNaAVzyGdFvDa9VkMrjgNdnr2wHBWxk")
        ...
        #expect(p2shp2wpkh == "2N6M3ah9EoggimNz5pnAmQwnpE1Z3ya3V7A")
        #expect(checkRoundTrip(
            source: source,
            scriptPubKey: "pkh:[OP_DUP OP_HASH160 4efd3ded47d967e4122982422c9d84db60503972 OP_EQUALVERIFY OP_CHECKSIG]",
    ...
    @Test func testHDKey1() throws {
        ...
        let desc = try OutputDescriptor(source)
        #expect(desc.requiresAddressIndex)
        #expect(desc.scriptPubKey() == nil) // requires wildcard
        #expect(desc.scriptPubKey(addressIndex: 0)† == "pkh:[OP_DUP OP_HASH160 2a05c214617c9b0434c92d0583200a85ef61818f OP_EQUALVERIFY OP_CHECKSIG]")
        #expect(desc.scriptPubKey(addressIndex: 1)† == "pkh:[OP_DUP OP_HASH160 49b2f81eea1ecb5bc97d78f2d8f89d9c861c3cf2 OP_EQUALVERIFY OP_CHECKSIG]")
        #expect(checkRoundTrip(
            source: source,
    ...
    @Test func testHDKey2() throws {
        ...
        #expect(purposePrivateKey.fullDescription == "[4efd3ded/44']tprv8c9mJ6Pkmf4eC93951CVmVVJBMnVPt4BoEsXVckBK4LeJ6dkPmDC1YEjLQSMGVAuUiHMbTTXYuosFLC3gdN5AjwXSjir94Tew4Pbh8V7mNM")
        ...
        #expect(accountPrivateKey.fullDescription == "[4efd3ded/44'/0'/0']tprv8fTYFKEQNDoECQKCFeYrXMtHNspLL1GLv2Ept6YasB7KdAggQ8MHBuzFimBMxdMeJbUWoETLKWNUucxXmgtJyNb3uaLzCxidmAY88AwYtmX/1'/*")

        let accountPublicKey = accountPrivateKey.public
        #expect(accountPublicKey.fullDescription == "[4efd3ded/44'/0'/0']tpubDC9aPjGeWbUu5sLz9JDSvmYPwuLGVLTFVKqcAcatHSuiTewT2XAsNQc7tsvhcXMz216Ed28BvtnWN73aANARJFSfFdT39vPTTf28Mtbkn7D/1'/*")
        
        let source = "pkh(\(accountPublicKey.fullDescription))"
        let desc = try OutputDescriptor(source)
        #expect(desc.requiresAddressIndex)
        #expect(desc.scriptPubKey(addressIndex: 0) == nil) // requires private key.
        ...
        #expect(desc.scriptPubKey(addressIndex: 0, privateKeyProvider: privateKeyProvider)† == "pkh:[OP_DUP OP_HASH160 c3d4f598ec80d57820226529645b7805d078cab0 OP_EQUALVERIFY OP_CHECKSIG]")
    ...
    @Test func test_SH_WSH_PKH() throws {
    ...
    @Test func test_SH_MULTI() throws {
    ...
    @Test func test_SH_SORTEDMULTI() throws {
    ...
    @Test func test_WSH_MULTI() throws {
    ...
    @Test func test_SH_WSH_MULTI() throws {
    ...
    @Test func test_WSH_MULTI_HD() throws {
        ...
        let desc = try OutputDescriptor(source)
        #expect(desc.requiresAddressIndex)
        #expect(desc.scriptPubKey(addressIndex: 0)† == "wsh:[OP_0 64969d8cdca2aa0bb72cfe88427612878db98a5f07f9a7ec6ec87b85e9f9208b]")
        #expect(checkRoundTrip(
            source: source,
    ...
    @Test func test_WSH_MULTI_HD_2() throws {
        ...
        #expect(Bitcoin.Address(scriptPubKey: scriptPubKey0, network: .testnet)!.string == "tb1qqsat6c82fvdy73rfzye8f7nwxcz3xny7t56azl73g95mt3tmzvgs9a8vjs")
        #expect(Bitcoin.Address(scriptPubKey: scriptPubKey1, network: .testnet)!.string == "tb1q7sgx6gscgtau57jduend6a8l445ahpk3dt3u5zu58rx5qm27lhkqgfdjdr")
    ...
    @Test func testCombo1() throws {
        ...
        #expect(desc.isCombo)
        #expect(!desc.requiresAddressIndex)
        #expect(desc.scriptPubKey(comboOutput: .pk)† == "pk:[022f01e5e15cca351daff3843fb70f3c2f0a1bdd05e5af888a67784ef3e10a2a01 OP_CHECKSIG]")
        #expect(desc.scriptPubKey(comboOutput: .pkh)† == "pkh:[OP_DUP OP_HASH160 9652d86bedf43ad264362e6e6eba6eb764508127 OP_EQUALVERIFY OP_CHECKSIG]")
        #expect(desc.scriptPubKey(comboOutput: .wpkh)† == "wpkh:[OP_0 9652d86bedf43ad264362e6e6eba6eb764508127]")
        #expect(desc.scriptPubKey(comboOutput: .sh_wpkh)† == "sh:[OP_HASH160 edcbce4e0cce791e8ddb72705133fa3566145fa6 OP_EQUAL]")
        #expect(checkRoundTrip(
            source: source,
    ...
    @Test func testCombo2() throws {
        ...
        let desc = try OutputDescriptor(source)
        #expect(desc.isCombo)
        #expect(desc.scriptPubKey(comboOutput: .pk)† == "pk:[04e220e776d811c44075a4a260734445c8967865f5357ba98ead3bc6a6552c36f22fa358bbfca32197efabe42755e5ab36c73b9bfee5b6ada22807cb125c1b7a27 OP_CHECKSIG]")
        #expect(desc.scriptPubKey(comboOutput: .pkh)† == "pkh:[OP_DUP OP_HASH160 335f3a94aeed3518f0baedc04330945e3dd0744b OP_EQUALVERIFY OP_CHECKSIG]")
        #expect(desc.scriptPubKey(comboOutput: .wpkh) == nil)
        #expect(desc.scriptPubKey(comboOutput: .sh_wpkh) == nil)
        #expect(checkRoundTrip(
            source: source,
    ...
    @Test func testChecksum() throws {
        ...
        let desc = try OutputDescriptor(source)
        #expect(desc.sourceWithChecksum == sourceWithChecksum)
        
        #expect(throws: Never.self) { try OutputDescriptor.validateChecksum(sourceWithChecksum) }
        
        let sourceWithBadChecksum = sourceWithChecksum.dropLast().appending("b")
        #expect(throws: (any Error).self) { try OutputDescriptor.validateChecksum(sourceWithBadChecksum) }
    }
    
    @Test func testAddressGeneration() throws {
        let source = "wsh(multi(1,xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEGuduB/1/0/*,xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFxHmwMkQTPH/0/0/*))"
        let desc = try OutputDescriptor(source)
        ...
        #expect(sortedAddresses == expectedAddresses)
        #expect(checkRoundTrip(
            source: source,
            cborHex: "",
            diag: """
    ...
    @Test func testPairKey() throws {
        ...
        #expect(desc.hdKey(chain: nil, addressIndex: 10) == nil)
        #expect(desc.hdKey(chain: .external, addressIndex: nil) == nil)

        let hdKey1 = desc.hdKey(chain: .external, addressIndex: 10)!.fullDescription
        #expect(hdKey1† == "[37b5eed4/84'/0'/0'/0/10]xpub6B7xKojKUGv71T4NppfMXVG3kpdJpGD4Q9293eCUeUK2seCWokQcfjrhss5jTyh7eL9xBmANUGCu4ouKndSaKSELp6TqCMREMBc59SjBXGo")
        let hdKey2 = desc.hdKey(chain: .internal, addressIndex: 10)!.fullDescription
        #expect(hdKey2† == "[37b5eed4/84'/0'/0'/1/10]xpub6BAS2fSgeDDjJuRizuj5sUeCWgYF5psPVAJxgHbeL2os6drBt9H9BJzWwqkVnn2J33V2vUcpHV5DzJj2UKoZctBLUVy7QBH9Y53XtpE92SE")
        let hdKey3 = desc.hdKey(chain: .internal, addressIndex: 11)!.fullDescription
        #expect(hdKey3† == "[37b5eed4/84'/0'/0'/1/11]xpub6BAS2fSgeDDjMMh78CyFAZgAifM4iuTHLMfjUbv3XYEVN69JfjQ6jgppmkrTfuRxyXzo9YCuPXw7kdEwtBwqRKwGymscqMPTGyqFcNc2uZC")
    ...
    @Test func testPairAddress() throws {
        let source = "wpkh([37b5eed4/84'/0'/0']xpub6BkU445MSEBXbPjD3g2c2ch6mn8yy1SXXQUM7EwjgYiq6Wt1NDwDZ45npqWcV8uQC5oi2gHuVukoCoZZyT4HKq8EpotPMqGqxdZRuapCQ23/<0;1>/*)"
        let desc = try OutputDescriptor(source)
        
        #expect(desc.address(useInfo: .init(), chain: nil, addressIndex: 10) == nil)
        #expect(desc.address(useInfo: .init(), chain: .external, addressIndex: nil) == nil)
        
        let address1 = desc.address(useInfo: .init(), chain: .external, addressIndex: 10)
        #expect(address1† == "bc1qe6hd9hc3cxy8fc88rpc6zja0w8urkzs902qw56")
        let address2 = desc.address(useInfo: .init(), chain: .internal, addressIndex: 10)
        #expect(address2† == "bc1qcatr2qs60xldaftxltz7kshsnya354mdnvwswc")
        let address3 = desc.address(useInfo: .init(), chain: .internal, addressIndex: 11)
        #expect(address3† == "bc1qx3qm9wz8eykx37s40mqfnd8rdfrsv374qqnl43")
    ...
    @Test func testParsePair() throws {
        let source = "wpkh([37b5eed4/84'/0'/0']xpub6BkU445MSEBXbPjD3g2c2ch6mn8yy1SXXQUM7EwjgYiq6Wt1NDwDZ45npqWcV8uQC5oi2gHuVukoCoZZyT4HKq8EpotPMqGqxdZRuapCQ23/<0;1>/*)"
        #expect(checkRoundTrip(
            source: source,
            cborHex: "",
