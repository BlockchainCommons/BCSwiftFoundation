...
struct ExampleStoreRemoteTests {
    @Test func testStoreRemote() throws {
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractResult(Data.self) == alicePayload1)
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractResult(Data.self) == bobPayload1)
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractResult(Data.self) == alicePayload2)
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(Set(try response.extractResults(Data.self)) == Set([alicePayload1, alicePayload2]))
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractError(String.self) == "userMismatch")
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractError(String.self) == "unknownPublicKey")
        }
        ...
        do {
            let request = StoreShareRequestBody.makeRequest(accountPrivateKey: alicePrivateKey, payload: alicePayload1)
            let response = exampleStore.handleRequest(request)
            #expect(try response.result(Receipt.self) == aliceReceipt1)
        }
        ...
        do {
            let request = RetrieveSharesRequestBody.makeRequest(accountPrivateKey: alicePrivateKey)
            let response = exampleStore.handleRequest(request)
            #expect(Set(try response.extractResults(Data.self)) == Set([alicePayload2]))
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractResult(String.self) == "bob@example.com")
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractError(String.self) == "noFallback")
        }
        ...
        do {
            ...
            let response = exampleStore.handleRequest(request)
            #expect(try response.extractError(String.self) == "invalidFallback")
        }
        ...
        do {
            ...
            // succeeds.
            #expect(try response.extractResult(KnownValue.self) == .Processing)
        }
